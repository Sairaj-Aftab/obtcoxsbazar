const AboutPage = () => {
  return (
    <section className="bg-white p-6 rounded-lg sm:shadow-lg max-w-3xl w-full mx-auto sm:my-5">
      ...
      <p className="mb-2">
        Welcome to Cox's Bazar, home of the world's longest sandy beach where
        the sun, sand, sea and hills await you.
      </p>
      ...
      <ul className="list-disc list-inside mb-6">
        <li>
          ...
          All bus services list and all destinations from Cox’s Bazar including
          types as AC, Non-AC & Sleeper Coach.
        </li>
        <li>
          <span className="font-semibold">Schedule Information:</span> Detailed
          bus schedules, including departure time, departure places and
        ...
        <li>
          <span className="font-semibold">Discounts and Offers:</span> Access to
        ...
        <li>
          <span className="font-semibold">24/7 Customer Service:</span> Support
      ...
      <ul className="list-disc list-inside mb-6">
        ...
        <li>
          ...
          Real-time tracking of buses can provide valuable data to city traffic
          management systems, helping to monitor and manage traffic flow more
          effectively.
        </li>
        <li>
          ...
          terminals contribute to reducing overall vehicle emissions, improving
          air quality and reducing environmental impacts.
        </li>
        <li>
          <span className="font-semibold">
      ...
      <p className="mt-6">
        ...
        posing new challenges in terms of comfort, reliability, and security in
        Cox’s Bazar.
      </p>
